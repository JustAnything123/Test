...
LEKTION('es-es', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g5303", satz: "Ojalá ___ (haber, yo) venido con vosotros.", loesung: "hubiera", tipps: ["hubiera", "habría", "he"], hinweis: "ojalá + Bedauern", ue: "Wäre ich doch mitgekommen." },
...
LEKTION('es-es', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g5405", satz: "Me gustaría que ___ (venir, vosotros).", loesung: "vinierais", tipps: ["vinierais", "vengáis", "venís"], hinweis: "Condicional → Imperfecto Subj.", ue: "Ich hätte gern, dass ihr kommt." }
    ]
  }
});
...
LEKTION('es-es', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g5604", satz: "Se me ___ (romper) el móvil ayer.", loesung: "rompió", tipps: ["rompió", "rompieron", "rompí"], hinweis: "el móvil = Einzahl", ue: "Mir ging gestern das Handy kaputt." },
