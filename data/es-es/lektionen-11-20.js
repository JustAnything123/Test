...
LEKTION('es-es', {
  ...
  grammatik: {
    ...
    uebungen: [
      { id: "g1501", satz: "Hoy ___ trabajado mucho. (yo)", loesung: "he", tipps: ["he", "ha", "has"], hinweis: "yo → ?", ue: "Heute habe ich viel gearbeitet." },
...
LEKTION('es-es', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g1804", satz: "Antes no ___ (haber) móviles.", loesung: "había", tipps: ["había", "hubo", "hay"], hinweis: "hay im Imperfecto", ue: "Früher gab es keine Handys." },
