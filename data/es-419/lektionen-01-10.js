...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      { id: "g0201", satz: "___ un problema con el refrigerador.", loesung: "Hay",  tipps: ["Hay", "Está"], hinweis: "un → ?", de: "Es gibt ein Problem mit dem Kühlschrank." },
...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g0306", satz: "¿A qué hora ___ (empezar) ustedes?", loesung: "empiezan", tipps: ["empiezan", "empezan"], hinweis: "ustedes = wie ellos", de: "Um wie viel Uhr fangen Sie an?" },
      ...
      { id: "g0305", satz: "¿Qué ___ (pedir) nosotros?", loesung: "pedimos", tipps: ["pedimos", "pidimos"], hinweis: "nosotros bleibt regelmäßig!", de: "Was bestellen wir?" }
    ]
  }
});
...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g0702", satz: "¿___ prestas tu carro? (a mí)", loesung: "Me", tipps: ["Me", "Te", "Le"], hinweis: "mir", de: "Leihst du mir dein Auto?" },
...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g0802", satz: "¿La carta? El mesero ___ la trae.", loesung: "nos", tipps: ["nos", "se", "les"], hinweis: "uns", de: "Die Karte? Der Kellner bringt sie uns." },
