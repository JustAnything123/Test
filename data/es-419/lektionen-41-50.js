...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      { id: "g4301", satz: "Busco un departamento que ___ (tener) terraza.", loesung: "tenga", tipps: ["tenga", "tiene", "tendrá"], hinweis: "noch nicht gefunden", de: "Ich suche eine Wohnung mit Terrasse." },
      { id: "g4302", satz: "Tengo un departamento que ___ (tener) terraza.", loesung: "tiene", tipps: ["tiene", "tenga", "tendría"], hinweis: "existiert", de: "Ich habe eine Wohnung mit Terrasse." },
...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g4405", satz: "___ (comer, ustedes) todo.", loesung: "Coman", tipps: ["Coman", "Comen", "Comed"], hinweis: "ustedes = Subjuntivform", de: "Esst alles auf." }
    ]
  }
});
