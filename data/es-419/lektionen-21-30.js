...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    erklaerung: `
      ...
      <em>Dime…</em>.</p>`,
    uebungen: [
      { id: "g2801", satz: "No sé ___ está mi celular.", loesung: "dónde", tipps: ["dónde", "donde", "que"], hinweis: "Fragewort mit Akzent", de: "Ich weiß nicht, wo mein Handy ist." },
      ...
      { id: "g2803", satz: "Dime ___ cuesta el boleto.", loesung: "cuánto", tipps: ["cuánto", "cuanto", "qué"], hinweis: "wie viel", de: "Sag mir, was die Fahrkarte kostet." },
...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      ...
      { id: "g2902", satz: "___ venden departamentos aquí.", loesung: "Se", tipps: ["Se", "Son", "Hay"], hinweis: "man verkauft", de: "Hier werden Wohnungen verkauft." },
...
LEKTION('es-419', {
  ...
  grammatik: {
    ...
    uebungen: [
      { id: "g3001", satz: "Nunca ___ (trabajar, yo) tanto.", loesung: "he trabajado", tipps: ["he trabajado", "trabajé", "trabajaba"], hinweis: "nunca = Erfahrung", de: "Ich habe noch nie so viel gearbeitet." },
